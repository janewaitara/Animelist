...
sealed interface Result<out T> {
    ...
    // data class Error(val errorStates: ErrorStates ) : Result<Nothing>
    data class Failure(val exception: Throwable) : Result<Nothing>
    data class ApplicationError(val errors: List<Error>) : Result<Nothing>
}
/*
sealed interface ErrorStates{
    data class Failure(val exception: Throwable) : ErrorStates
    data class ApplicationError(val errors: List<Result.Error>) : ErrorStates
}*/
